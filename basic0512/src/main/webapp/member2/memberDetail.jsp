...
<%
	// html소스와 자바코드를 섞어쓰기 할 때 당분간은 맨 앞쪽에 위치한다
	// 대체로는 상관이 없음, 여기에 적힌 자바코드는 이미 톰캣 서버에서 실행되고 
    ...
    if(mList !=null) {
      size = mList.size();
      rmap = mList.get(0); // 파라미터는 존재한다면 0일 것이다 - 왜냐하면 조회가 되더라도 한 건이기 때문
    }
%>
<!DOCTYPE html>
<html>
...
<script type="text/javascript">
	...
	const memberUpdate = () => {
		...
		//이벤트 버블링 효과가 있어서 이벤트가 하위 컴포넌트에 전이되는 것을 막아 줘야 한다 - 버튼을 눌렀는데 화면이 새로고침괴거나 깜빡한다면 의심해봄
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body">
           <form id="f_member" method="get" action="./memberUpdate.pj2">
