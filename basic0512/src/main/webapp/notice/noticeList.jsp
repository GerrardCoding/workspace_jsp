...
<%
	...
	out.print(nList);//[{},{},{}] -> JSON 포맷 -> 하이브리드앱서비스가능하니까...
%>
<!DOCTYPE html>
<html>
<head>
...
<script type="text/javascript">
	...
	const noticeDetail = (n_no) => {
		console.log(n_no);
		location.href="/notice/noticeDetail.pj1?n_no="+n_no;//3 or 2
	}
	const noticeInsert = () => {
...
%>		   
		      		<tr>
		        		<td width="10%" align="center"><%=rmap.get("N_NO") %></td><!-- 대문자로 적어줘야한다 "N_NO" -->
	...
	<div class="modal" id="noticeForm">
	  <div class="modal-dialog modal-dialog-centered">
	    <div class="modal-content">
	      ...
	      <!-- form전송하기 {method, action="./noticeInsert.pj1"} -->
