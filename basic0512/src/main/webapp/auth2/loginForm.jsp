...
<body>
	...
	<div class="container">
		...
		<form id="f_login" action="/auth2/login.pj3" method="post">
			...
			<a href="https://kauth.kakao.com/oauth/authorize?client_id=a2003af7efd216db91c88af72684a992&redirect_uri=http://localhost:9000/auth/kakao/callback&response_type=code"><img height="38px" src="/images/kakao_login/ko/kakao_login_medium_narrow.png"></a>			
