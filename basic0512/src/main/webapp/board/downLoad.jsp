...
<%
//사용자 화면(boardList.jsp)으로 부터 파일명을 받아서 저장함.
//js-> fileDown()
	String b_file = request.getParameter("b_file");
	String fname = b_file;
	//out.print("b_file: 8->euc"+b_file);		
	//out.print("<br>");		
	//아래 경로는 톰캠서버가 바라보는 프로젝트 내의 pds폴더가리킴
	String filePath = "D:\\workspace_jsp\\basic0512\\src\\main\\webapp\\pds"; // 절대경로.	
	...
	try{
		...
		//사용한 자원은 반납해줌. - 묵시적으로 처리됨 - 명시적으로 처리하는 것 권장사항 - 시점을 앞당김 - 서버에 대한 부담을 줄임
